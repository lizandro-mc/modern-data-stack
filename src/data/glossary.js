export const glossary = [
  ...
  },
  {
    ...
    desc: 'En RD rige la Ley 155-17. Exige monitoreo transaccional, detección de patrones sospechosos y reporte a la UAF en plazos estrictos. Caso de uso de ML en tiempo real sobre Event Hubs.',
  ...
  {
    term: 'BCRD',
    full: 'Banco Central de la República Dominicana',
    desc: 'Autoridad monetaria y cambiaria de RD. Define el encaje legal, publica tasas de referencia y recibe reportes de posición de liquidez. Fuente de datos de tasas para el dominio de tesorería.',
  ...
  {
    term: 'CNBV',
    full: 'Comisión Nacional Bancaria y de Valores — NO aplica en RD',
    desc: '⚠️ Este organismo es de México. En República Dominicana el supervisor bancario es la Superintendencia de Bancos (SB). Ver término "SB" en este glosario.',
  ...
  {
    term: 'DGII',
    full: 'Dirección General de Impuestos Internos (República Dominicana)',
    desc: 'Autoridad tributaria de RD. Recibe reportes FATCA y CRS de los bancos sobre cuentas de no residentes. El stack genera los extracts de clientes clasificados para reporte automático.',
    url: 'https://dgii.gov.do/',
  },
  {
    term: 'Data as a Feature',
  ...
  {
    term: 'Encaje Legal',
    full: 'Encaje Legal (Reserva de Encaje BCRD)',
    desc: 'Porcentaje de los depósitos que los bancos deben mantener inmovilizado según las instrucciones del BCRD. El stack calcula y reporta la posición de encaje diariamente desde el dominio de tesorería.',
    url: 'https://www.bancentral.gov.do/a/d/2535-regulaciones-monetarias-y-financieras',
  },
  {
    term: 'FATCA',
  ...
  {
    term: 'Ley 155-17',
    full: 'Ley 155-17 contra el Lavado de Activos y Financiamiento del Terrorismo (RD)',
    desc: 'Marco AML de República Dominicana. Exige a los bancos reportar operaciones sospechosas a la UAF en máximo 48 horas. El stack automatiza la detección y generación del reporte.',
    url: 'https://www.uaf.gob.do/legislacion/leyes/',
  },
  {
    term: 'Ley 172-13',
    full: 'Ley 172-13 de Protección de Datos Personales (RD)',
    desc: 'Ley de privacidad de República Dominicana. Regula la recolección, tratamiento y transferencia de datos personales de ciudadanos dominicanos. Equivalente local al GDPR. En el stack: enmascaramiento PII en Silver para dev/stage.',
    url: 'https://indotel.gob.do/servicios/tic/proteccion-de-datos-personales/',
  },
  {
    term: 'Ley 183-02',
    full: 'Ley Monetaria y Financiera 183-02 (RD)',
    desc: 'Marco legal principal del sistema financiero dominicano. Regula la constitución, operación y supervisión de los bancos. Define los reportes prudenciales que deben enviarse a la SB.',
